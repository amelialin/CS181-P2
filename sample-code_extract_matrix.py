...
#        print(call,"call")
    ...
    print(call_counter,"call counter")
...
def main():
    ...
    X_valid, t_valid, valid_ids = create_data_matrix(10, 13, TRAIN_DIR)
...
a = [b[0] for b in X_train]
c = pandas.DataFrame(a)
feature_mat=c.fillna(0)    
